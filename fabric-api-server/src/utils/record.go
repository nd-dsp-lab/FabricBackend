...
type Record struct {
	RecordID   string `json:"recordID" default:""`
	DroneID    string `json:"droneID" default:"Drone01"`
	PilotID    string `json:"pilotID" default:"Pilot01"`
	ZoneID     string `json:"zoneID" default:"Zone01"`
	RecordType string `json:"recordType"`
	Reserved   string `json:"reserved" default:"<Reserved>"`
}

// SerializedRecord example:
//
...
func GetRecordDBObject(record *Record) (*Record, error) {
	_, err := json.Marshal(record)
	if err != nil {
		return nil, err
	}

	record_db_obj := &Record{
